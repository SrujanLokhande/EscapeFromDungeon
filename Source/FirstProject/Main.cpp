...
AMain::AMain()
{
	...
	// Create Camera Boom (pulls towards the player is there is a collision)
	...
	// Dont rotate the character with controller rotation
	...
	GetCharacterMovement()->bOrientRotationToMovement = true; // Charcater moves in the direction of input...
